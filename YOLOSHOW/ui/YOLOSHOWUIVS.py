...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.title.setText(QCoreApplication.translate("MainWindow", u"长空之眼", None))
        self.label.setText(QCoreApplication.translate("MainWindow", u"GUI", None))
        self.label_3.setText(QCoreApplication.translate("MainWindow", u"嘟嘟嘟嘟", None))
